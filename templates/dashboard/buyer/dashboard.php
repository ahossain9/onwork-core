...
<div class="row stats">
	<div class="col-lg-3">
		<a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=projects" class="dashboard-stats-item"> 		
	 		<h1><?php echo esc_html( $projects->found_posts ); ?></h1>
	 		<h5><?php echo esc_html__( 'Active Projects', 'prolancer' ); ?></h5>
	 	</a>
	</div>
	<div class="col-lg-3">
		<a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=proposals" class="dashboard-stats-item"> 		
	 		<h1><?php echo esc_html( count($project_proposal_count) ); ?></h1>
	 		<h5><?php echo esc_html__( 'Proposals', 'prolancer' ); ?></h5>
	 	</a>
	</div>
	<div class="col-lg-3">
		<a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=ongoing-projects" class="dashboard-stats-item"> 		
	 		<h1><?php echo esc_html( count($ongoing_project_count) ); ?></h1>
	 		<h5><?php echo esc_html__( 'Ongoing Projects', 'prolancer' ); ?></h5>
	 	</a>
	</div>
	<div class="col-lg-3">
		<a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=completed-projects" class="dashboard-stats-item"> 		
