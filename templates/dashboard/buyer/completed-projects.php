<div class="white-padding mb-4">
  <h2 class="mb-0"><?php echo esc_html__('Completed Projects', 'prolancer'); ?></h2>
</div>
              ...
              <td>
                <a href="<?php if (function_exists('onwork_get_page_url_by_template')) {
                          ...
                          if (get_option('permalink_structure')) {
                            ...
                            echo "&";
                          } ?>fed=completed-project-details&proposal_id=<?php echo esc_attr($result['id']); ?>" class="prolancer-btn small-btn text-white"><?php echo esc_html__('Details', 'prolancer'); ?></a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
