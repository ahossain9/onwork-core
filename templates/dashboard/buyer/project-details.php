  ...
  <table class="prolancer-table">
    ...
    while ( $projects->have_posts() ) : $projects->the_post(); ?>
      ...
      <tr>
        ...
        <td><a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=proposals&project_id=<?php echo get_the_ID(); ?>"><?php echo esc_html__( 'Proposal', 'prolancer' ); ?></a></td>
        <td>
