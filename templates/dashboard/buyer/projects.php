          ...
          <tr>
            ...
            <td>
              ...
              if ($projects->post->post_status == 'publish') {?>
                <a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=proposals&project_id=<?php echo get_the_ID(); ?>"><?php echo esc_html( 'Proposal (' , 'prolancer').$proposal_count.')'; ?></a>
              <?php }else {
            ...
            <td>
              <ul class="list-inline mb-0">
                <li class="list-inline-item"><a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=create-project&project_id=<?php echo get_the_ID(); ?>"><i class="fad fa-edit"></i></a></li>
