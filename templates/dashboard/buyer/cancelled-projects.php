...
<div class="white-padding mb-4">
  <h2 class="mb-0"><?php echo esc_html__( 'Cancelled Projects', 'prolancer' ); ?></h2>
</div>
    ...
    <table class="prolancer-table">
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            <?php $price = get_post_meta($project_id, 'project_price', true);
          ...
          <td>
            <a href="<?php if(function_exists('prolancer_get_page_url_by_template')){ echo esc_url(prolancer_get_page_url_by_template('prolancer-dashboard.php'));} if(get_option('permalink_structure')){echo"?";}else{echo"&";} ?>fed=disputes" class="prolancer-btn bg-danger small-btn text-white"><?php echo esc_html__( 'Open dispute', 'prolancer' ); ?></a>
          </td>
        </tr>          
        <?php } ?>
      </tbody>
