...
<div class="white-padding">
  ...
  if( is_user_logged_in() ){ 
    ...
    if($wpdb->get_var("SHOW TABLES LIKE ${table}") == $table) {
      $query = "SELECT * FROM ${table} WHERE `seller_id` = ${seller_id} AND `status` ='cancel' ORDER BY timestamp DESC ${offset}, ${items_per_page}";
