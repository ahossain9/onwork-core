<?php
/**
 * onwork_core course grid widget for elementor
 * @package Onwork_Core
 * @since 1.0.0
 */
...
class Course_Grid extends Widget_Base {
    ...
    public function get_name() {
        return 'onwork-course-grid';
    }
    
    public function get_title() {
        return __( 'Course Grid', 'onwork-core' );
    }

    public function get_icon() {
        return 'onwork-core-icon eicon-gallery-grid';
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'course_per_page',
            [
                'label' => __( 'Course Per Page', 'onwork-core' ),
